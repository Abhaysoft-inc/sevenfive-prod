...
import { ArrowRight, BookOpen, Calendar, TrendingUp, Users, CheckCircle, Clock, BarChart3 } from "lucide-react";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
                    <div className="text-center">
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                            SevenFive revolutionizes attendance tracking with smart analytics,
                            real-time insights, and seamless class management for students and educators.
                        </p>
